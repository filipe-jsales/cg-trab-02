...
?>
    ...
    ?>
        <div class="prime-mover-unable-to-activate-license-help">
            <p><span class="prime-mover-unable-activate-license-span">
                ...
                <a class="prime-mover-external-link" target="_blank" href="<?php echo esc_url(CODEXONICS_ACTIVATE_LICENSE_GUIDE); ?>"><?php esc_html_e("Check this complete guide", "prime-mover"); ?>
                </a>
            </p>
        </div>
    <?php
        ...
        <div class="wrap">
            <div class="">
                ...
                <div class="notice-large highlight">
                    <p><?php printf(esc_html__('Thank you for using GM Mover ! Start migrating now by going to Migration Tools', 'prime-mover'), "<strong>$plan</strong>", $target); ?> : </p>
                </div>
    ...
    public function showGettingStartedOnFreeUsers()
    {
        ...
        $support = sprintf(
            esc_html__('%s is available with free version', 'prime-mover'),
